...
const QString BITCOIN_IPC_PREFIX("BluechipCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click BluechipCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start BluechipCoin: click-to-pay handler");
    else
...
{
    // clicking on BluechipCoin: URLs creates FileOpen events on the Mac:
