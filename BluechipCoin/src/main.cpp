...
// Copyright (c) 2013 The BluechipCoin developers
...
uint256 hashGenesisBlock("0x0000005ca788faf91526f7f1d5e8b0bc8588291ed304f76dbe9b666e589b184b");
static const unsigned int timeGenesisBlock = 1480428000;
...
const string strMessageMagic = "BluechipCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Nov 29, 2016. The BluechipCoin released. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x50f5fdce041c14d26922388fdd51b4fea6382084a32618953d86105c5f048db1"));
...
unsigned char pchMessageStart[4] = { 0x14, 0x10, 0x0b, 0x06 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BluechipCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BluechipCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BluechipCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BluechipCoin-miner");
    ...
    try { loop {
        ...
        printf("Running BluechipCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BluechipCoinMiner terminated\n");
        throw;
    }
}
